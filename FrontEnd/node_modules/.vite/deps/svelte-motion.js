...
var framesync = (update) => {
  const passTimestamp = ({ delta: delta2 }) => update(delta2);
  return {
...
function instance11($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("animate" in $$props2)
      $$invalidate(6, animate3 = $$props2.animate);
    if ("value" in $$props2)
      $$invalidate(0, value = $$props2.value);
  };
  if ($$props && "$$inject" in $$props) {
...
function create_each_block(key_1, ctx) {
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      if (switch_value !== (switch_value = /*feat*/
      ctx[21].Component)) {
        if (switch_instance) {
          group_outros();
          const old_component = switch_instance;
...
function instance13($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("isSVG" in $$new_props)
      $$invalidate(11, isSVG = $$new_props.isSVG);
    ...
    if ("targetEl" in $$new_props)
      $$invalidate(12, targetEl = $$new_props.targetEl);
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("createVisualElement" in $$props)
      $$invalidate(7, createVisualElement = $$new_props.createVisualElement);
    if ("visualStateConfig" in $$props)
      $$invalidate(8, visualStateConfig = $$new_props.visualStateConfig);
    if ("mounted" in $$props)
    ...
    if ("motionProps" in $$props)
      $$invalidate(4, motionProps = $$new_props.motionProps);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function instance14($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<UseDomEvent> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("ref" in $$props2)
...
function create_fragment15(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & /*ref*/
      1)
        usedomevent_changes.ref = /*ref*/
        ctx2[0];
      if (dirty & /*eventName*/
      2)
        usedomevent_changes.eventName = getPointerEventName(
          /*eventName*/
          ctx2[1]
        );
      if (dirty & /*handler, eventName*/
      6)
        usedomevent_changes.handler = /*handler*/
        ctx2[2] && wrapHandler(
          /*handler*/
          ctx2[2],
          /*eventName*/
      ...
      if (dirty & /*options*/
      8)
        usedomevent_changes.options = /*options*/
        ctx2[3];
      if (dirty & /*$$scope*/
      32) {
...
function instance15($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<UsePointerEvent> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("ref" in $$props2)
      $$invalidate(0, ref = $$props2.ref);
...
function create_fragment20(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (dirty & /*props*/
      1)
        usepangesture_changes.props = /*props*/
        ctx2[0];
      if (dirty & /*visualElement*/
      2)
        usepangesture_changes.visualElement = /*visualElement*/
        ctx2[1];
      usepangesture.$set(usepangesture_changes);
      const usetapgesture_changes = {};
      if (dirty & /*props*/
      1)
        usetapgesture_changes.props = /*props*/
        ctx2[0];
      if (dirty & /*visualElement*/
      2)
        usetapgesture_changes.visualElement = /*visualElement*/
        ctx2[1];
      usetapgesture.$set(usetapgesture_changes);
      const usehovergesture_changes = {};
      if (dirty & /*props*/
      1)
        usehovergesture_changes.props = /*props*/
        ctx2[0];
      if (dirty & /*visualElement*/
      2)
        usehovergesture_changes.visualElement = /*visualElement*/
        ctx2[1];
      usehovergesture.$set(usehovergesture_changes);
      const usefocusgesture_changes = {};
      if (dirty & /*props*/
      1)
        usefocusgesture_changes.props = /*props*/
        ctx2[0];
      if (dirty & /*visualElement*/
      2)
        usefocusgesture_changes.visualElement = /*visualElement*/
        ctx2[1];
...
function instance20($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<UseGestures> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("props" in $$props2)
      $$invalidate(0, props = $$props2.props);
...
function instance26($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("props" in $$props2)
      $$invalidate(1, props = $$props2.props);
    if ("animate" in $$props2)
      $$invalidate(2, animate3 = $$props2.animate);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function create_dynamic_element(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      svelte_element_data = get_spread_update(svelte_element_levels, [dirty & /*props*/
      16 && /*props*/
      ctx2[4]]);
      if (/-/.test(
        /*___tag*/
...
function instance28($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("___tag" in $$new_props)
      $$invalidate(0, ___tag = $$new_props.___tag);
    if ("$$scope" in $$new_props)
...
function instance30($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<PresenceChild> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("isPresent" in $$props2)
      $$invalidate(0, isPresent2 = $$props2.isPresent);
    if ("onExitComplete" in $$props2)
      $$invalidate(1, onExitComplete = $$props2.onExitComplete);
    if ("initial" in $$props2)
      $$invalidate(2, initial = $$props2.initial);
    if ("custom" in $$props2)
      $$invalidate(3, custom = $$props2.custom);
    if ("presenceAffectsLayout" in $$props2)
      $$invalidate(4, presenceAffectsLayout = $$props2.presenceAffectsLayout);
    if ("isCustom" in $$props2)
      $$invalidate(5, isCustom = $$props2.isCustom);
    if ("$$scope" in $$props2)
      $$invalidate(7, $$scope = $$props2.$$scope);
...
function create_each_block3(key_1, ctx) {
  ...
  const block = {
    ...
    p: function update(new_ctx, dirty) {
      ...
      16)
        presencechild_changes.isPresent = /*child*/
        ctx[22].present;
      if (dirty & /*initial*/
      2)
        presencechild_changes.initial = /*initial*/
        ctx[1] ? void 0 : false;
      if (dirty & /*childrenToRender, custom*/
      17)
        presencechild_changes.custom = /*child*/
        ctx[22].onExit ? (
          /*custom*/
          ctx[0]
        ) : void 0;
      ...
      4)
        presencechild_changes.presenceAffectsLayout = /*presenceAffectsLayout*/
        ctx[2];
      if (dirty & /*childrenToRender*/
      16)
        presencechild_changes.onExitComplete = /*child*/
        ctx[22].onExit;
      if (dirty & /*isCustom*/
      8)
        presencechild_changes.isCustom = /*isCustom*/
        ctx[3];
...
function instance31($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<AnimatePresence> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("list" in $$props2)
      $$invalidate(6, list = $$props2.list);
    if ("custom" in $$props2)
      $$invalidate(0, custom = $$props2.custom);
    if ("initial" in $$props2)
      $$invalidate(1, initial = $$props2.initial);
    if ("onExitComplete" in $$props2)
      $$invalidate(7, onExitComplete = $$props2.onExitComplete);
    if ("exitBeforeEnter" in $$props2)
      $$invalidate(8, exitBeforeEnter = $$props2.exitBeforeEnter);
    if ("presenceAffectsLayout" in $$props2)
      $$invalidate(2, presenceAffectsLayout = $$props2.presenceAffectsLayout);
    if ("show" in $$props2)
      $$invalidate(9, show = $$props2.show);
    if ("isCustom" in $$props2)
      $$invalidate(3, isCustom = $$props2.isCustom);
    if ("$$scope" in $$props2)
      $$invalidate(18, $$scope = $$props2.$$scope);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("isCustom" in $$props2)
      $$invalidate(3, isCustom = $$props2.isCustom);
    if ("_list" in $$props2)
      $$invalidate(10, _list = $$props2._list);
    if ("isInitialRender" in $$props2)
      $$invalidate(11, isInitialRender = $$props2.isInitialRender);
    if ("filteredChildren" in $$props2)
      $$invalidate(12, filteredChildren = $$props2.filteredChildren);
    if ("presentChildren" in $$props2)
      $$invalidate(13, presentChildren = $$props2.presentChildren);
    if ("allChildren" in $$props2)
      $$invalidate(19, allChildren = $$props2.allChildren);
    if ("exiting" in $$props2)
      $$invalidate(20, exiting = $$props2.exiting);
    if ("childrenToRender" in $$props2)
      $$invalidate(4, childrenToRender = $$props2.childrenToRender);
    if ("forceRender" in $$props2)
      $$invalidate(14, forceRender = $$props2.forceRender);
    if ("isl" in $$props2)
      $$invalidate(15, isl = $$props2.isl);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function instance33($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<UseAnimation> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("$$scope" in $$props2)
      $$invalidate(1, $$scope = $$props2.$$scope);
